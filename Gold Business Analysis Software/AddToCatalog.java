...
public class AddToCatalog extends JPanel implements ActionListener {
    ...
    // JTextField makingCharges;
    // JTextField kdm;
    // JTextField cashDiscount;
    //JTextField typeOfJewelryInput;
    ...
    public AddToCatalog(ProjectWindow w, AdminCatalogPage catalogPage, CustomerCatalogPage c, AdminInventoryPage inven) {
        window = w;
        catalog = catalogPage;
        catCus = c;
        inventory = inven;
        ...
        // makingChargesLabel.setBounds(680, 245, 200, 40);
        ...
        // makingCharges = new JTextField("Enter Making Charges");
        // makingCharges.setEditable(true);
        // makingCharges.setBounds(825, 251, 340, 30);
        // makingCharges.setFont(new Font("Sans", Font.PLAIN, 15));
        // makingCharges.addFocusListener(new FocusListener() {
        //     @Override
        //     public void focusGained(FocusEvent e) {
        //         if (makingCharges.getText().equals("Enter Making Charges")) {
        ...
        //     public void focusLost(FocusEvent e) {
        //         // TODO Auto-generated method stub
        //         if (makingCharges.getText().equals("")) {
        //             makingCharges.setText("Enter Making Charges");
        //         }
        //     }
        // });

        // kdm = new JTextField("Enter KDM");
        // kdm.setEditable(true);
        // kdm.setBounds(825, 301, 340, 30);
        // kdm.setFont(new Font("Sans", Font.PLAIN, 15));
        // kdm.addFocusListener(new FocusListener() {
        //     @Override
        //     public void focusGained(FocusEvent e) {
        //         if (kdm.getText().equals("Enter KDM")) {
        //             kdm.setText("");
        //         }
        //         incorrectLabel.setVisible(false);
        //     }
        ...
        //     public void focusLost(FocusEvent e) {
        //         // TODO Auto-generated method stub
        //         if (kdm.getText().equals("")) {
        //             kdm.setText("Enter KDM");
        //         }
        //     }
        // });

        // cashDiscount = new JTextField("Enter Cash Discount");
        // cashDiscount.setEditable(true);
        // cashDiscount.setBounds(825, 351, 340, 30);
        // cashDiscount.setFont(new Font("Sans", Font.PLAIN, 15));
        // cashDiscount.addFocusListener(new FocusListener() {
        //     @Override
        //     public void focusGained(FocusEvent e) {
        //         if (cashDiscount.getText().equals("Enter Cash Discount")) {
        ...
        //     public void focusLost(FocusEvent e) {
        //         // TODO Auto-generated method stub
        //         if (cashDiscount.getText().equals("")) {
        //             cashDiscount.setText("Enter Cash Discount");
        //         }
        //     }
        // });

        // typeOfJewelry = new JTextField("Enter Type");
        // typeOfJewelry.setEditable(true);
        // typeOfJewelry.setBounds(825, 401, 340, 30);
        // typeOfJewelry.setFont(new Font("Sans", Font.PLAIN, 15));
        // typeOfJewelry.addFocusListener(new FocusListener() {
        //     @Override
        //     public void focusGained(FocusEvent e) {
        //         if (typeOfJewelry.getText().equals("Enter Type")) {
        //             typeOfJewelry.setText("");
        //         }
        //         incorrectLabel.setVisible(false);
        //     }
        ...
        //     public void focusLost(FocusEvent e) {
        //         // TODO Auto-generated method stub
        //         if (typeOfJewelry.getText().equals("")) {
        //             typeOfJewelry.setText("Enter Type");
        //         }
        //     }
        // });
        ...
        save.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    if(!(filename.substring(filename.length()-4, filename.length()).equals(".png")) && !(filename.substring(filename.length()-5, filename.length()).equals(".jpeg"))){
                    ...
                    AdminCatalogPage.catalogElements.add(new CatalogHolder(filename, weightOfGems, totalWeight, costOfGems, (String) typeInput.getSelectedItem(), enterName.getText(), quantityNumber));
                    CustomerCatalogPage.catalogElementsCus.add(new CatalogHolder(filename, weightOfGems, totalWeight, costOfGems, (String) typeInput.getSelectedItem(), enterName.getText(), quantityNumber));
                    // catalog.update();
                    catalog.reUpdate();
                    catCus.reUpdate();
                    inventory.update();
        ...
        if(e.getSource() == getPicture) {
            ...
            SwingWorker sw = new SwingWorker() {
                ...
                protected Object doInBackground() throws Exception {
                    Thread.sleep(100); //simulate large image takes long to load
